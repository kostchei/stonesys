    ...
    "archetypes": [
      {
        ...
        "choice_moves": [
          ...
          {
            "name": "Wards & Bindings",
            "description": "When you mark a boundary with sacred signs, spend 1 Stock and describe who or what they affect (using no more words than your level). Also, choose whether the affected beings are repelled or trapped by the signs. When your wards or bindings are first tested, roll the relevant stat"
          },
          {
            "name": "Wild Soul",
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Quick Wit",
            "description": "When you Seek Insight under pressure, you may use INT as the stat instead of WIS and add 'What opportunity does no one else see?' to the list of possible questions."
          },
          {
            "name": "A Life of Crime",
        ...
        "choice_moves": [
          ...
          {
            "name": "Npc'",
            "description": "s pride with a well-placed quip, they must do 1 (their choice): Attack, doing +1d4 damage if they hit but adding 1 blue Boost die to your next roll against them Stoop to your level and respond in kind Spend a few moments fuming, sputtering, or controlling their temper"
          },
          {
            "name": "Skill At Arms",
            "description": "When you wield a weapon with speed and grace, roll the relevant stat"
          },
          {
            "name": "Parry & Riposte",
            "description": "(Requires Skill at Arms) When you Defend with a weapon that you can wield quickly, you can spend 1 Readiness to both halve an attack's effects/damage and strike back at the attacker (deal your damage with 1 black Setback die), instead of spending 1 Readiness for each."
          },
          {
            "name": "Silver Tongued",
            "description": "When you use words to avoid suspicion or trouble, roll the relevant stat"
          }
        ],
        ...
        "signature_moves": [
          {
            ...
            "description": "When you step into a conflict between members of the community, roll CHA. On success with Advantage, they accept your judgment. On success with Threat, they accept it but demand a concession."
          },
          {
            "name": "The Chronicle",
            "description": "When you Know Things about the history of Stonetop, you add 1 blue Boost die."
          }
        ],
        "choice_moves": [
          {
            "name": "The Hammer And The Book",
            "description": "When you strike a thing of supernatural chaos, roll the relevant stat"
          },
          {
          ...
          {
            "name": "Well-Read",
            "description": "When you name the source in which you read about the matter at hand, roll the relevant stat"
          },
          {
      ...
      },
      {
        ...
        "signature_moves": [
          ...
          {
            "name": "Channel Light",
            "description": "Roll WIS. On success with Advantage, you heal 2d4 HP of a touched ally or deal 2d4 damage to an undead/spirit. On success with Threat, you choose one but draw unwanted attention."
          }
        ],
        "choice_moves": [
          {
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Expert Tracker",
            "description": "When you follow tracks in the wild, you add 1 blue Boost die. You can determine their size, number, and speed."
          },
          {
        ...
        "choice_moves": [
          ...
          {
            "name": "Survivalist",
            "description": "When you Forage, pick 1 extra choice (even on failure, pick 1) and add \"Find or fashion some useful item or supply ("
          },
          {
          ...
          {
            "name": "Wild Speech",
            "description": "The grunts, barks, chirps, and calls of natural beasts are as a language to you. You can understand their intentions and communicate basic ideas. When you Persuade a beast, you can choose to use the relevant stat"
          }
        ],
      ...
      },
      {
        ...
        "choice_moves": [
          ...
          },
          {
            ...
            "description": "When you cleverly use your environment to harm or impede your foe(s), roll the relevant stat"
          },
          {
            "name": "Arcane Adept",
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Impetuous Youth",
            "description": "When you make a move and fail, you can give it your all and turn failure into success with Threat, but you suffer damage, cause collateral damage, or lose an item."
          },
          {
            "name": "Driven",
        ...
        "choice_moves": [
          {
            "name": "Resourceful",
            "description": "When you Defy Danger and fail, ask the"
          },
          {
