...
const CAMPAIGNS_DATA = [
  {
    ...
    "mechanics": "Features the Steading sheet, community ratings (Scale, Safety, Prosperity, Influence, Supply), and seasonal moves. Resolves with three-band rolls, miss XP, and community advancement.",
    "archetypes": [
      {
        "name": "The Blessed",
        ...
        "backgrounds": [
          ...
          },
          {
            ...
            "description": "Maybe not by wolves, but you grew up in the wild. Beasts of land and air were your siblings. The sighing wind taught you language. The trees and rocks were your home. Were you one of the Forest Folk? Abandoned or orphaned? Lured into the Wood? Regardless, you get the Trackless Step move (go mark it now). Also, when you Forage, you have advantage. For some reason, you've made yourself known to Stonetop and perhaps you even call it home. But the ways of humans are still strange to you. Once per session, when your wild ways offend or alienate you from someone, mark XP ."
          },
          {
            "name": "VESSEL",
        ...
        "choice_moves": [
          ...
          {
            "name": "Wards & Bindings",
            "description": "When you mark a boundary with sacred signs, spend 1 Stock and describe who or what they affect (using no more words than your level). Also, choose whether the affected beings are repelled or trapped by the signs. When your wards or bindings are first tested, roll +"
          },
          {
            "name": "Wild Soul",
            "description": "(Requires level 2+ and the Blessed) Each time you take this move, gain a Ranger move of your choice for which you qualify. You can't pick Improved Stat or Superior Stat."
          },
          {
            "name": "Nature'S Wrath",
            "description": "(Requires level 6+ and Danu's Grasp) Danu's Grasp gains the area tag and can affect any creature. A mortal reduced to 0"
          }
        ],
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Quick Wit",
            "description": "When you Seek Insight under pressure, you may roll +INT instead of +WIS and add 'What opportunity does no one else see?' to the list of possible questions."
          },
          {
            "name": "A Life of Crime",
            "description": "You start with either Burgle or Light Fingers as an extra move, and burglar tools or a hidden stash."
          }
        ],
        "choice_moves": [
          {
            "name": "Perceptive",
            "description": "When you Seek Insight, you may ask 1 additional question. Even on a 6-, you can ask 1 question (though you might not like how you learn the answer)."
          },
          {
            "name": "Rapier Wit",
            "description": "When you pierce an"
          },
          {
            "name": "Npc'",
            "description": "s pride with a well-placed quip, they must do 1 (their choice): Attack, doing +1d4 damage if they hit but giving you advantage on your next roll against them Stoop to your level and respond in kind Spend a few moments fuming, sputtering, or controlling their temper"
          },
          {
            "name": "Skill At Arms",
            "description": "When you wield a weapon with speed and grace, roll +"
          },
          {
            "name": "Parry & Riposte",
            "description": "(Requires Skill at Arms) When you Defend with a weapon that you can wield quickly, you can spend 1 Readiness to both halve an attack's effects/damage and strike back at the attacker (deal your damage with disadvantage), instead of spending 1 Readiness for each."
          },
          {
            "name": "Silver Tongued",
            "description": "When you use words to avoid suspicion or trouble, roll +"
          }
        ],
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          },
          {
            ...
            "description": "You left behind a life of violence and a name mothers used to scare their children. For whatever reason, the people of Stonetop took you (back?) in and treat you like one of their own. When you Persuade using violence or threats against someone who knows your black reputation, you can roll +STR instead of +CHA. Also, if you take the Formidable move, you can choose to roll +CON instead of +CHA. When you fight to kill without mercy or hesitation, you deal +1d4 damage."
          },
          {
            "name": "STORM-MARKED",
        ...
        "signature_moves": [
          {
            "name": "Formidable",
            "description": "You have 1 armor. When you are reduced to 0 HP in battle, you can keep fighting. Each time you take damage while at 0 HP, mark 1. When you would regain HP, clear all marks."
          },
          {
            "name": "Fighting Style",
            "description": "You deal +1d4 damage when fighting with your signature weapon style (e.g., two-handed, dual wield)."
          }
        ],
        "choice_moves": [
          {
          ...
          {
            "name": "Relentless",
            "description": "When you Clash and your foe survives, you gain advantage the next time you Clash with them."
          },
          {
            "name": "Seasoned Warrior",
            "description": "(Requires level 2+ and the Heavy) Take a move from the Fox, Marshal, Ranger, or Seeker playbooks, for which you otherwise qualify. You can pick from a different playbook each time. (You can't pick Improved Stat or Superior Stat.)"
          },
          {
            "name": "Situational Awareness",
            "description": "When you Seek Insight, add the following to the list of questions you can ask: Who or what here is the biggest threat? What is my enemy's true position? What here can"
          },
          {
            "name": "Uncanny Reflexes",
            "description": "When you are unarmored and carrying a normal or light load, you impose disadvantage on any damage you take that you could dodge or roll with."
          },
          {
            "name": "Unfettered",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "LEGACY",
            "description": "You are the latest in a long line of Judges\u2014born here, apprenticed to the prior Judge, and charged with the passing of the mantle. The Chronicle is a rich repository of lore, but there's no index, so good luck finding anything. When you Know Things about the people or history of Stonetop, you have advantage. When you spend days, weeks, or months poring over the Chronicle, ask the GM a question, and the GM will tell you what you learn in that time."
          },
          {
            "name": "MISSIONARY",
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Helior's Light",
            "description": "You carry a small source of light that never burns out. You can channel it to illuminate dark ruins or ward off spirits of darkness."
          },
          {
            "name": "Channel Light",
            "description": "Roll +WIS. On a 10+, you heal 2d4 HP of a touched ally or deal 2d4 damage to an undead/spirit. On a 7-9, you choose one but draw unwanted attention."
          }
        ],
        "choice_moves": [
          {
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Lead the Crew",
            "description": "You command a militia crew. They follow your orders in battle. Roll +CHA to direct them under fire."
          },
          {
            "name": "Veteran Crew",
            "description": "Your crew starts with the 'respected' tag and has higher training."
          }
        ],
        "choice_moves": [
          {
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Expert Tracker",
            "description": "When you follow tracks in the wild, you have advantage. You can determine their size, number, and speed."
          },
          {
            "name": "Animal Companion",
            "description": "You have a faithful beast companion (usually a wolf or bird). It acts as a follower with 3 Loyalty."
          }
        ],
        "choice_moves": [
          {
          ...
          },
          {
            ...
            "description": "When you Seek Insight, you can ask, \"What here stinks of the unnatural?\" for free, even on a 6-."
          },
          {
            "name": "St Alker",
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Antiquarian",
            "description": "When you inspect an ancient ruin or relic, you can ask the GM 2 questions about its origins, powers, or creators."
          },
          {
            "name": "Let's Make a Deal",
            "description": "You have contact with a strange patron or spirit. You can trade favors or items for forbidden secrets."
          }
        ],
        "choice_moves": [
          {
          ...
          {
            "name": "Safety First",
            "description": "When you spend an hour or so preparing your mystical defenses, hold 2 Protection. When you are affected by harmful magic, spend 1 Protection either to gain advantage on any roll to resist it or to halve its damage/effects."
          },
          {
            "name": "Sage Advice",
      ...
      },
      {
        ...
        "signature_moves": [
          {
            "name": "Impetuous Youth",
            "description": "When you make a move and fail, you can give it your all and turn a failure (6-) into a success with cost (7-9), but you suffer damage, cause collateral damage, or lose an item."
          },
          {
            "name": "Driven",
            "description": "You have a grand destiny or purpose. Mark XP whenever you take actions that directly serve this purpose at personal risk."
          }
        ],
        "choice_moves": [
          {
            "name": "Resourceful",
            "description": "When you Defy Danger and roll a 6-, ask the"
          },
          {
            "name": "Something To Remember Me By",
            "description": "When you spend Readiness (from Defend) to strike back at an attacker, you deal +1d4 damage and scar, mark, or diminish them in some way (the"
          },
          {
            "name": "Tough Love",
            "description": "When you honestly think another"
          },
          {
            "name": "Underestimated",
            "description": "As long as you avoid overt hostility, no enemy will consider you a threat. When you first make your move against an enemy who underestimates you, you have advantage."
          },
          {
            "name": "Up With People",
            "description": "| When you converse with someone ("
          },
          {
            "name": "Npc",
            "description": ") you can hold 2 Rapport with them. If you do, they hold 1 Rapport with you. During the conversation, either of you can spend 1 Rapport to ask the other player one of the following and get an honest answer. What weighs you down or holds you back? What drives you forward? What lesson would you have me learn? What do you think of me, truly?"
          }
        ],
    ...
    "archetypes": [
      {
        ...
        "backgrounds": [
          {
            "name": "City Sellsword",
            "description": "You have worked for merchants, nobles, and thieves. You know the layout of the city guards and street patrols, giving you advantage when navigating urban conflicts."
          },
          {
            "name": "Northern Barbarian",
            "description": "Like Fafhrd, you came from the cold wastes. You have immense strength and are immune to the subtle ennuis of city life. You have advantage when resisting magical charms."
          },
          {
        ...
        "signature_moves": [
          {
            "name": "Carouse & Brawl",
            "description": "When you spend a night drinking and looking for fights, roll +CHA. On a 10+, you gain 2 Story Points and a useful rumor. On a 7-9, you choose one and start the next morning with a hangover (+1 setback die to physical rolls)."
          },
          {
            "name": "Shrug It Off",
        ...
        "choice_moves": [
          {
            "name": "Heavy Hitter",
            "description": "Your melee attacks gain the forceful tag, letting you knock enemies back or down on a roll with advantage."
          },
          {
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Guild Deserter",
            "description": "You fled the Thieves' Guild. You know their signs, secret marks, and hideouts, but they are looking for you. You have advantage when identifying traps and secret doors."
          },
          {
            "name": "Cat Burglar",
            "description": "You specialize in high-altitude climbs. You make no sound when moving across rooftops, and you ignore setbacks related to vertical navigation."
          },
          {
        ...
        "signature_moves": [
          {
            "name": "Shadow Step",
            "description": "When you attempt to move unseen through darkness or cover, roll +DEX. On a 10+, you move silently and remain undetected. On a 7-9, you are safe but must leave something behind or make a detour."
          },
          {
            "name": "Pick Lock",
        ...
        "choice_moves": [
          {
            "name": "Escape Artist",
            "description": "You can slip out of ropes, cuffs, and tight spots easily. You have advantage on checks to escape physical bonds."
          },
          {
            "name": "Backstab",
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          {
            "name": "Hedge Magician",
            "description": "You brew minor potions and read cards. You have advantage when identifying magical items, relics, or active curses."
          },
          {
        ...
        "signature_moves": [
          {
            ...
            "description": "When you cast a spell, choose its intensity (minor or major) and roll +INT. On a 10+, the spell succeeds. On a 7-9, it succeeds but you choose: draw attention, take 1d6 strain, or spell effect is distorted."
          },
          {
            "name": "Arcane Sight",
        ...
        "choice_moves": [
          {
            "name": "Counterspell",
            "description": "When you defend an ally against a spell, you can roll +INT to absorb or redirect the magic. On a 10+, you nullify it completely."
          },
          {
            "name": "Scroll Writing",
          ...
          {
            "name": "Forbidden Lore",
            "description": "When you Know Things about ancient demons, dark gods, or sorcery, you roll +INT with advantage."
          }
        ],
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          {
            "name": "Ascetic Hermit",
            "description": "You spent years fasting. You require half the food and water of a normal human and have advantage on rolls to resist poisons and diseases."
          }
        ],
        "instincts": [
          "Preach in streets",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you pray to your minor deity under pressure, roll +WIS. On a 10+, the deity acts in your favor (healing 2d6 HP or striking a foe). On a 7-9, they act but demand an immediate holy vow or sacrifice."
          },
          {
            "name": "Preach & Persuade",
            "description": "When you address a crowd in the street to sway their opinion, you can roll +WIS instead of +CHA."
          }
        ],
        "choice_moves": [
          {
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You grew up in the saddle. You have advantage when riding, fighting from horseback, or tracking across open fields."
          },
          {
          ...
          },
          {
            ...
            "description": "You survived hot sands and bandit ambushes. You ignore setbacks due to heat, fatigue, or lack of sleep."
          }
        ],
        "instincts": [
          "Look for work",
        ...
        "choice_moves": [
          {
            "name": "Tactical Eye",
            "description": "When you enter a battle, ask the GM 'Who is the most dangerous foe here?' and 'What terrain can I exploit?'. You have advantage on your next action relating to the answers."
          },
          {
            "name": "Weapon Mastery",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Noble Bastard",
            "description": "You have noble blood but no title. You know the etiquette of the high courts and noble houses, giving you advantage when mingling in high society."
          },
          {
            "name": "Guild Perfumer",
            "description": "You know how to mix scents and minor chemical reagents. You start with advantage when identifying poisons, drugs, and perfumes."
          },
          {
            "name": "Alleyway Actor",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you lie to or seduce an NPC, roll +CHA. On a 10+, they believe you and will act on it. On a 7-9, they believe you for now but demand a token of proof or a minor favor."
          },
          {
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          {
            "name": "Military Scout",
            "description": "You served as a sniper or advance scout in regional wars. You have advantage when lining up a shot from a far distance."
          }
        ],
        "instincts": [
          "Study targets",
        ...
        "signature_moves": [
          {
            "name": "Death Strike",
            "description": "When you strike an unaware target with a close weapon, roll +DEX. On a 10+, you deal double damage. On a 7-9, you deal normal damage but remain hidden or escape immediately."
          },
          {
            "name": "Poisoner's Art",
        ...
        "choice_moves": [
          {
            "name": "Wall Crawler",
            "description": "You can scale sheer stone walls without ropes or climbing gear. You ignore setbacks related to vertical climbs."
          },
          {
            "name": "Silent Kill",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You run a legitimate-looking shop that deals in stolen artifacts. You have advantage when evaluating the value of strange items or art."
          },
          {
        ...
        "signature_moves": [
          {
            ...
            "description": "When you seek a buyer or contact for illegal goods, roll +CHA. On a 10+, you find someone who will pay full value in silver. On a 7-9, they buy it but demand a favor or trade instead of coin."
          },
          {
            "name": "Bribe",
        ...
        "choice_moves": [
          ...
          },
          {
            ...
            "description": "When you barter or negotiate a contract, you roll +CHA with advantage."
          },
          {
            "name": "Safehouse",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Gutter Urchin",
            "description": "You grew up on the streets. You know the sewer routes, secret passages, and drainage pipes of the city, giving you advantage when escaping pursuers."
          },
          {
        ...
        "signature_moves": [
          {
            ...
            "description": "When you spend time begging or sitting in the streets, roll +WIS. On a 10+, you gather 2 useful rumors and remain entirely unnoticed. On a 7-9, you get 1 rumor but draw attention from a rival beggar or thug."
          },
          {
    ...
    "archetypes": [
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You fought in Urik's famous pits. You have advantage when fighting before a crowd, and you can invoke your name to intimidate common soldiers."
          },
          {
            "name": "Mul Pit-Fighter",
            "description": "You are a Mul (human-dwarf hybrid). You have immense stamina and do not need sleep for up to three days, ignoring fatigue setbacks."
          },
          {
        ...
        "choice_moves": [
          {
            "name": "Crowd Pleaser",
            "description": "When you defeat a foe in a dramatic way, roll +CHA. On a 10+, onlookers are inspired or terrified (ally gains a blue boost, enemy gets a setback)."
          },
          {
          ...
          {
            "name": "Unbreakable",
            "description": "When you take damage that would reduce you to 0 HP, you can roll +CON. On a 10+, you stay at 1 HP. On a 7-9, you stay at 1 HP but take a condition."
          }
        ],
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You served in Tyr's administration. You know the legal codes and how to manipulate taxes, records, and warrants to your advantage."
          },
          {
          ...
          },
          {
            ...
            "description": "You hunted templar deserters and veiled alliance members. You have advantage when detecting magical activity or lies."
          }
        ],
        "instincts": [
          "Enforce laws",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you order a citizen or slave of your city-state to do something, roll +CHA. On a 10+, they obey immediately. On a 7-9, they obey but grumble, delay, or demand a bribe."
          },
          {
        ...
        "choice_moves": [
          ...
          },
          {
            ...
            "description": "Allies acting under your direct orders gain +1 blue boost to their rolls to resist fear, magic, or environmental danger."
          },
          {
            "name": "Judicial Sentence",
            "description": "By declaring someone an outlaw, you grant all allies advantage on damage rolls against them."
          }
        ],
        ...
        "backgrounds": [
          {
            ...
            "description": "You belong to the underground rebellion. You know their signs, secret meeting places, and have advantage when concealing your spellcasting from templars."
          },
          {
            "name": "Solitary Hermit",
            "description": "You studied magic alone in the deep desert. You know how to read ancient stone tablets and have advantage when researching ancient ruins."
          },
          {
        ...
        "signature_moves": [
          {
            ...
            "description": "When you cast a spell without harming the environment, roll +INT. On a 10+, the spell succeeds. On a 7-9, it succeeds but you must spend 1 strain or the spell's effect is delayed."
          },
          {
            "name": "Veiled Signs",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You are wanted by both templars and the Veiled Alliance. You know how to hide in the ruins of the wastes and have advantage when set up in defensive positions."
          },
          {
            "name": "Renegade Templar",
            "description": "You stole arcane scrolls from a templar library. You know templar procedures and have advantage when hiding within city-states."
          },
          {
        ...
        "signature_moves": [
          {
            "name": "Defiling Spark",
            "description": "When you cast an arcane spell, you can choose to defile the surrounding soil. If you do, gain +1 yellow die to your check, but all plant life within a 10-meter radius turns to ash, and allies take a black setback die due to choking dust."
          },
          {
            "name": "Ash Blast",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You were trained in a hidden psionic academy in the Ringwall Mountains. You have deep knowledge of the Way and have advantage when identifying psionic phenomena."
          },
          {
            "name": "City Gladiator",
            "description": "You used your mind-powers to survive the arenas of Balic. You have advantage when using telekinesis to manipulate items in combat."
          },
          {
            "name": "Wild Talent",
        ...
        "signature_moves": [
          {
            "name": "Mind Strike",
            "description": "You can strike a foe's mind directly. Roll +WIS. On a 10+, deal your damage die (ignores armor) and the target is stunned for 1 round. On a 7-9, choose one: deal damage or stun them."
          },
          {
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          },
          {
            ...
            "description": "You run a small, illegal caravan. You know how to bypass toll gates and hide contraband from templars, giving you advantage when smuggling."
          },
          {
            "name": "Elven Bazar Trader",
            "description": "You grew up in the fast-moving elven markets. You can spot a forgery or bad deal instantly and have advantage when bartering."
          }
        ],
        "instincts": [
          "Count coins",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you buy, sell, or trade goods in a market, roll +CHA. On a 10+, you double your profits or buy items at half price. On a 7-9, you secure a fair deal but must throw in a minor favor or secret."
          },
          {
            "name": "Caravan Leader",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You serve the element of Fire. You start with a holy brazier and have advantage when casting fire spells or resisting heat damage."
          },
          {
            "name": "Water Searcher",
            "description": "You serve the element of Water. You can locate underground water sources in the desert and have advantage when negotiating with thirsty factions."
          },
          {
            "name": "Silt Walker",
            "description": "You serve the element of Earth/Dust. You can walk across silt basins without sinking, ignoring silt setbacks."
          }
        ],
        "instincts": [
          "Pray to elements",
        ...
        "signature_moves": [
          {
            "name": "Elemental Pact",
            "description": "Choose your primary element (Fire, Water, Earth, Air). When you call upon your element to alter the environment (e.g. summon wind, shape clay, spark flame), roll +WIS. On a 10+, the effect is clean and powerful. On a 7-9, choose one: it is brief, or you take 1d6 strain."
          },
          {
            "name": "Purify Water",
        ...
        "choice_moves": [
          ...
          {
            "name": "Grounded Earth",
            "description": "When you are touching solid rock or soil, you gain +1 armor and have advantage on rolls to resist physical knockbacks."
          },
          {
            "name": "Wind Ride",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Gith Hunter",
            "description": "You lived among the Gith. You know how to track Gith raiders, speak their gutter language, and have advantage when setting up ambushes in rocky badlands."
          },
          {
            "name": "Caravan Scout",
          ...
          {
            "name": "Ruins Explorer",
            "description": "You specialize in navigating the ruins of ancient Athas. You have advantage when searching for items in ancient stone complexes."
          }
        ],
        "instincts": [
          "Track beasts",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you lead a party through the deep desert under pressure (sandstorms, heat waves), roll +WIS. On a 10+, you navigate safely without losing resources. On a 7-9, you arrive safely but the journey costs 1 supply (rations or water)."
          },
          {
            "name": "Wasteland Stealth",
            "description": "When you hide in desert terrain (dunes, rocks, silt edges), you have advantage. Enemies cannot spot you unless they walk directly onto your position."
          }
        ],
        "choice_moves": [
          {
            "name": "Beast Whisperer",
            "description": "You can calm wild desert beasts (Inixes, Kanks). Roll +WIS. On a 10+, they will not attack you and will allow you to pass. On a 7-9, they pass but demand food."
          },
          {
            "name": "Sniper Shot",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Arena Slave",
            "description": "You cleaned the pits and survived the beatings. You have advantage when defending against physical torture or intimidation, and you start with 1 armor."
          },
          {
        ...
        "signature_moves": [
          {
            ...
            "description": "When you use raw strength to break bonds, gates, or chains, roll +STR. On a 10+, you break them cleanly and silently. On a 7-9, you break them but cause noise or injure yourself (take 1d4 damage)."
          },
          {
            "name": "Rebel Call",
            "description": "When you speak to slaves or outcasts to incite rebellion, roll +CHA. On a 10+, they create a distraction or riot in your favor. On a 7-9, they assist you but demand protection or weapons."
          }
        ],
        "choice_moves": [
          {
            "name": "Dirty Fighting",
            "description": "When you fight dirty (throwing sand in eyes, low blows), you can stun a target for 1 round on a success with advantage."
          },
          {
            "name": "Slip Away",
            "description": "When you attempt to escape from captivity or a chase, you can roll +DEX with advantage."
          },
          {
            "name": "Shared Burden",
    ...
    "archetypes": [
      {
        ...
        "backgrounds": [
          {
            "name": "Wolf Friend",
            "description": "You grew up riding giant wolves. You have advantage when riding, tracking, or hunting with wolves, and you can understand their body language perfectly."
          },
          {
            "name": "Silent Hunter",
        ...
        "choice_moves": [
          {
            "name": "Pack Tactics",
            "description": "When you and your wolf attack the same target, you have advantage on your attack and damage rolls."
          },
          {
            "name": "Wild Scent",
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          },
          {
            ...
            "description": "You led the tribe across the great desert. You know how to find oases and avoid heat stroke, giving you advantage when guiding travelers in dry lands."
          },
          {
            "name": "Diplomat Chief",
            "description": "You believe in peace between tribes. You have advantage when negotiating with other elf chiefs or strange factions."
          }
        ],
        "instincts": [
          "Make choices",
        ...
        "signature_moves": [
          {
            "name": "The Way",
            "description": "When you command your tribe members or allies under pressure, roll +CHA. On a 10+, they follow your order without hesitation, gaining a blue boost. On a 7-9, they follow but demand a reason or concession."
          },
          {
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Memory Keeper",
            "description": "You spent years looking at ancient paintings and scrolls. You know the exact history of the High Ones and have advantage when decoding runes."
          },
          {
            "name": "Star Reader",
          ...
          },
          {
            ...
            "description": "You bear a strong physical resemblance to the ancient High Ones. You have advantage when interacting with ancient elven spirits or constructs."
          }
        ],
        "instincts": [
          "Read stars",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you study an ancient relic or ruin, roll +INT. On a 10+, the GM will tell you its history, purpose, and how to activate it. On a 7-9, you learn its history but activate it incorrectly or draw attention."
          },
          {
        ...
        "choice_moves": [
          {
            ...
            "description": "When you Know Things about ancient beasts, geology, or primeval history, you roll +INT with advantage."
          },
          {
            "name": "Predict Storm",
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          },
          {
            ...
            "description": "You know how to find healing herbs in any forest. You start with advantage when identifying plants, roots, and poisons."
          },
          {
            "name": "Soothing Voice",
            "description": "Your presence calms troubled minds. You have advantage when attempting to calm terrified NPCs or wild animals."
          }
        ],
        "instincts": [
          "Heal sick",
        ...
        "signature_moves": [
          {
            "name": "Flesh-Shaping",
            "description": "When you touch an injured creature and focus your inner magic, roll +WIS. On a 10+, they heal 2d6 HP and their injuries are knit. On a 7-9, they heal 1d6 HP but you take 1d4 strain or draw spirits."
          },
          {
            "name": "Cure Toxin",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            ...
            "description": "You spent centuries in the quiet halls of Blue Mountain. You know the tunnels perfectly and have advantage when hiding inside stone structures."
          },
          {
          ...
          {
            "name": "Wind Glider",
            "description": "You studied the currents of air. You ignore setbacks due to wind, high altitude, or thin air."
          }
        ],
        "instincts": [
          "Hover silently",
        ...
        "choice_moves": [
          ...
          {
            "name": "Ancient Memory",
            "description": "When you try to recall events from thousands of years ago, you roll +INT with advantage."
          },
          {
            "name": "Hover Strike",
            "description": "When you attack a foe from above while hovering, you have advantage on your damage roll."
          }
        ],
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Pet Sprite",
            "description": "You are a tiny, insectoid sprite who lives with the Wolfriders. You can hide inside a pouch or hair lock, and you ignore setbacks related to small size."
          },
          {
            "name": "Web Spinner",
            "description": "You know how to spin cocoons. You start with advantage when constructing bindings or securing objects."
          },
          {
            "name": "Berry Finder",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you spin a web around an item or creature, roll +DEX. On a 10+, they are wrapped in a cocoon that preserves them perfectly (no decay, no aging, ignores damage). On a 7-9, they are preserved but the web is thin and breaks on any contact."
          },
          {
        ...
        "choice_moves": [
          ...
          {
            "name": "Tiny Spy",
            "description": "Because of your small size, you have advantage when sneaking into restricted areas or listening to conversations."
          },
          {
            "name": "Sweet Spark",
      ...
      },
      {
        ...
        "backgrounds": [
          ...
          {
            "name": "Tomb Architect",
            "description": "You designed the burial mounds of the ancestors. You have advantage when identifying ancient traps or sarcophagi."
          },
          {
            "name": "Gem Carver",
        ...
        "signature_moves": [
          {
            "name": "Stone-Shaping",
            "description": "When you touch solid rock or stone, you can mold it like wet clay. Roll +STR. On a 10+, you mold it into a useful shape (a wall, a spear, a door) cleanly and quickly. On a 7-9, you mold it but it takes 1d6 strain or the shape has structural flaws."
          },
          {
            "name": "Stone Melding",
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Oasis Farmer",
            "description": "You cultivate crops in the hot desert sands. You require half the water of a normal elf and have advantage when finding edible desert plants."
          },
          {
            "name": "Master Potter",
            "description": "You craft jars and bricks. You start with 3 sturdy clay jars and have advantage when constructing simple camp facilities."
          },
          {
            "name": "Sorrow's End Elder",
            "description": "You are respected in the village. You have advantage when resolving disputes peacefully between villagers or guests."
          }
        ],
        "instincts": [
          "Cultivate oasis",
        ...
        "signature_moves": [
          {
            ...
            "description": "When you work to find or grow food/water in a dry land, roll +WIS. On a 10+, you secure double the rations and create a small safe camp. On a 7-9, you secure normal rations but the camp is exposed or temporary."
          },
          {
            "name": "Calm Conflict",
            "description": "When you step between two arguing parties to negotiate peace, you can roll +CHA. On a 10+, they agree to lay down their weapons for now. On a 7-9, they agree but demand you arbitrate the dispute."
          }
        ],
        "choice_moves": [
          {
          ...
          },
          {
            ...
            "description": "You know how to treat heat stroke and desert fever. You have advantage when treating conditions caused by heat or thirst."
          },
          {
            "name": "Villager's Hospitality",
            "description": "When you welcome a stranger to your camp or village, you gain a blue boost die to all social rolls against them for the scene."
          }
        ],
      ...
      },
      {
        ...
        "backgrounds": [
          {
            "name": "Redwood Archer",
            "description": "You trained in the high redwood branches. You can climb trees with speed and have advantage when firing from elevated positions."
          },
          {
            "name": "Night Scout",
            "description": "You hunt during the moons' rise. You have acute night vision and ignore setbacks due to poor light or shadows."
          },
          {
            "name": "Beast Tracker",
        ...
        "signature_moves": [
          {
            "name": "Silent Arrow",
            "description": "When you fire a bow from hidden cover, roll +DEX. On a 10+, deal your damage and remain undetected. On a 7-9, deal your damage but your position is revealed to your target."
          },
          {
            "name": "Camouflage",
